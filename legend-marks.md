...
<table id="legendMarkTable" class="display" style="width:100%">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img class="legend-mark-img" src="https://darkages-screenshot-archive.s3.us-east-1.amazonaws.com/legend-marks/{{ mark.image }}" alt="{{ mark.text }}" style="height: 40px;" loading="lazy"></td>
    </tr>
    {% endfor %}
  </tbody>
</table>
